...
\begin{proof}
%  If  $a = 1$ then Theorem~\ref{thm:2-adic-S} trivially holds true because
%  and since $S(0, a) = 0$, we may assume $a \ne 1$ and $n \ge 1$.
%  Hence, we may assume $a \ne 1$.
%  Since $S(0, a) = 0$, we
  Theorem~\ref{thm:2-adic-S} trivially holds true in the case $a = 1$ because $S(n, 1) = n$ for every $n \in \bN$.
  Hence, we may assume $a \ne 1$.
  For each $n \in \bN$, let  $\mu(n)$ denote the $2$-adic valuation of $S(n, a)$.
  % Note that $t(n)$ is an odd integer Since $4$ divides $a - 1$,
  %$(a - 1) \mathbin{/} 2$ is an even integer, and thus $t(n)$ is an odd integer.
  The crux is to prove $\mu(2n) = \mu(n) + 1$ and $\mu(2n + 1) = 0$ for every $n \in \bN$.
  Let $n \in \bN$.
  Put
  $$
  ...
  % \end{align*}
  \begin{equation} \label{eq:S2na-2tnSna}
  S(2 n, a) = 2  S(n, a) t(n) \, .
  \end{equation} 
  % S(2 n, a) = 2 \left(1 + \frac{a - 1}{2}  S(n, a)  \right) S(n, a) \, .
  Besides, $t(n)$ is an odd integer because $(a - 1) \mathbin{/} 2$ is an even integer.
  It follows $\mu(2n) = \mu(n) + 1$.
  In addition, Equation~\eqref{eq:S2na-2tnSna} ensures that $S(2n, a)$ is even, whence  
  $S(2n + 1, a) = 1 + S(2n, a) a$ is odd.
  It follows $\mu(2n + 1) = 0$.
...
\begin{exercise}
  ...
  \item Compute the $2$-adic valuation of $S(n, a)$ (hint: the $2$-adic valuation of $S(n, a)$ equals $0$, $\infty$,  or
    $\nu_2(n) + \nu_2(a + 1) - 1$).
  \end{enumerate}
\end{exercise}
