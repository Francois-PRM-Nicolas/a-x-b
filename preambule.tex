...
\begin{proof}
  Theorem~\ref{thm:2-adic-S} is easily deduced from the following two claims and a simple induction on $n$:
  \begin{enumerate}
  \item For every $n \in \bN$, the $2$-adic valuation of $S(2n, a)$ is equal to that of $2 S(n, a)$.
%    is one more than that of $S(n, a)$.
  \item For every $n \in \bN$, $S(2n + 1, a)$ is odd.
  \end{enumerate} 
  It remains to prove the claims.
  Since $S(n, 1) = n$ for every $n \in \bN$,
  both claims (and Theorem~\ref{thm:2-adic-S}) trivially hold true in the case where $a = 1$.
  ...
  % $$
  Since Equation~\eqref{eq:ak-1-a-1-Ska} holds true for $k = n$ and for $k = 2n$,
  straightforward computations yield
  \begin{align*}
    (a - 1)  S(2 n, a)  & = a^{2n} - 1 \\
                        & = (a^n - 1) (a^n + 1) \\
                        & = (a^n - 1)(2 + (a^n - 1)) \\
                        & = (a - 1) S(n, a) (2 + (a - 1) S(n, a)) \,, %\\ 
      %       & = (a - 1) S(n, a) (2 + 4 t(n)) \\
       %      & = 2 (a - 1) S(n, a) (1 + 2t(n))  
%                        & = (a - 1) S(n, a) (2 + 4 t(n)) \, ,
  \end{align*}
  ...
  Therefore, the first claim holds true.
  In particular, it ensures that $S(2n, a)$ is even,
  whence
  $$S(2n + 1, a) = 1 + S(2n, a) a$$
  is odd and the second claim is proven.
\end{proof}

% \begin{exercise}
%   The aim of this exercise is to prove the converse of Theorem~\ref{thm:2-adic-S}.
%   Let $a \in \bZ$ be such that the $2$-adic valuation of $S(2, a)$ is equal to~$1$.
%   Prove that $4$ divides $a - 1$.
% \end{exercise}
...
\begin{exercise}
  ...
  \item Compute the $2$-adic valuation of $S(n, a)$
    (hint: the $2$-adic valuation of $S(n, a)$ equals $0$, $\infty$, or $\nu_2(n) + \nu_2(a + 1) - 1$).
  \end{enumerate}
\end{exercise}
...
\begin{proof}
  ...
  Theorem~\ref{thm:p-adic-S} is easily deduced from the following two claims and a simple induction on $n$: 
  \begin{enumerate}
  \item For every $n \in \bN$, $p$ divides $S(n, a)$ if, and only if, $p$ divides~$n$.
  \item For every $n \in \bN$, the $p$-adic valuation of $S(p n, a)$ is equal to that of $p S(n, a)$.
  \end{enumerate}
...
$$
(a - 1) S(p n, a) = a^{p n} - 1 = (a^n - 1) S(p, a^n) 
$$
...
\begin{exercise}
 Let $a \in \bZ$.
  ...
  \item Let $p$ be a prime.
    Prove that $p$ divides $a - 1$ if, and only if, $p$ divides $S(p, a)$ (hint: Fermat).
  \end{enumerate}
\end{exercise}
